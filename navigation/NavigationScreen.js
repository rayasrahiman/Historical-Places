    ...
    <Stack.Navigator>
      <Stack.Screen name="Home" component={HomeScreen} options={({ navigation }) => ({
        ...
        headerRight: () => {
          ...
          return(
          <TouchableOpacity style={styles.randomButton} onPress={() => navigation.navigate("Random", {HistoricalPlace: randomItem})}><Text style={styles.randomButtonText}>Random Place</Text></TouchableOpacity>)}
      })} />
      <Stack.Screen name="Details" component={DetailScreen} options={({route}) => ({
        headerTitle: `${route.params.HistoricalPlace.historic_name}`
      })} />
      <Stack.Screen name="Random" component={RandomPlace} options={({route}) => ({
        headerTitle: `${route.params.HistoricalPlace.historic_name}`
      })} />
    </Stack.Navigator>
    </NavigationContainer>
